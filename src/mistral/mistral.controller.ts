...
import { DeleteFileDto, DownloadFileDto, ListFilesDto, RetrieveFileDto, UploadFileDto } from './dto/Files/files.dto';
...
export class MistralController {
  ...
  async cancelFineTuningJob(@Param('jobId') cancelJobDto: CancelFineTuningJobDto) {
  ...
  chatCompletionStream(@Body() chatDto: ChatCompletionStreamDto): Observable<string> {
  ...
  fimCompletionStream(@Body() fimDto: FIMCompletionStreamDto): Observable<string> {
  ...
  agentsCompletionStream(@Body() agentsDto: AgentsCompletionStreamDto): Observable<string> {
