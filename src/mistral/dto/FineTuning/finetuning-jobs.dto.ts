import { JobsApiRoutesFineTuningCancelFineTuningJobRequest$inboundSchema, JobsApiRoutesFineTuningGetFineTuningJobRequest$inboundSchema, JobsApiRoutesFineTuningGetFineTuningJobsRequest$inboundSchema, JobsApiRoutesFineTuningStartFineTuningJobRequest$inboundSchema } from "@mistralai/mistralai/models/operations";
...
export class ListFineTuningJobsDto extends createZodDto(
  z.object({
    request: JobsApiRoutesFineTuningGetFineTuningJobsRequest$inboundSchema.optional(),
