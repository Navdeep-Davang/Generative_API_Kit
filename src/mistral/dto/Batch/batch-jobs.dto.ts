import { JobsApiRoutesBatchCancelBatchJobRequest$inboundSchema, JobsApiRoutesBatchGetBatchJobRequest$inboundSchema, JobsApiRoutesBatchGetBatchJobsRequest$inboundSchema } from "@mistralai/mistralai/models/operations";
