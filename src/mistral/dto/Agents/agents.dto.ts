import { AgentsCompletionRequest$inboundSchema, AgentsCompletionStreamRequest$inboundSchema } from "@mistralai/mistralai/models/components";
...
export class AgentsCompletionStreamDto extends createZodDto(AgentsCompletionStreamSchema) {}