import { FilesApiRoutesDeleteFileRequest$inboundSchema, FilesApiRoutesDownloadFileRequest$inboundSchema, FilesApiRoutesListFilesRequest$inboundSchema, FilesApiRoutesRetrieveFileRequest$inboundSchema, FilesApiRoutesUploadFileMultiPartBodyParams$inboundSchema } from "@mistralai/mistralai/models/operations";
import { z } from "zod";
