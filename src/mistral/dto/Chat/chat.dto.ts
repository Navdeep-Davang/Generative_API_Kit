import { ChatCompletionRequest$inboundSchema, ChatCompletionStreamRequest$inboundSchema } from "@mistralai/mistralai/models/components";
...
export class ChatCompletionStreamDto extends createZodDto(ChatCompletionStreamSchema) {}