import { FIMCompletionRequest$inboundSchema, FIMCompletionStreamRequest$inboundSchema } from "@mistralai/mistralai/models/components";
...
export class FIMCompletionStreamDto extends createZodDto(FIMCompletionStreamSchema) {}