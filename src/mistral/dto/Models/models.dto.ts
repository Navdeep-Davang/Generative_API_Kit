...
import { DeleteModelV1ModelsModelIdDeleteRequest$inboundSchema, JobsApiRoutesFineTuningArchiveFineTunedModelRequest$inboundSchema, JobsApiRoutesFineTuningUnarchiveFineTunedModelRequest$inboundSchema, JobsApiRoutesFineTuningUpdateFineTunedModelRequest$inboundSchema, RetrieveModelV1ModelsModelIdGetRequest$inboundSchema } from "@mistralai/mistralai/models/operations";
...
export class UnarchiveFineTunedModelDto extends createZodDto(
  z.object({
    request: JobsApiRoutesFineTuningUnarchiveFineTunedModelRequest$inboundSchema,
    options: RequestOptionsSchema.optional(),
  })
) {}