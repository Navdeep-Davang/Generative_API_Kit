import { ClassificationRequest$inboundSchema, ChatClassificationRequest$inboundSchema } from "@mistralai/mistralai/models/components";
...
export class ContentModerationDto extends createZodDto(ContentModerationSchema) {}
